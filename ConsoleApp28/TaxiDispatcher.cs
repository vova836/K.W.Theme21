...
{
    /// <summary>
    /// Создаем класс Диспетчера
    /// </summary>
    class TaxiDispatcher
    {
        /// <summary>
        /// Можно добавить разнообразие диалога Диспетчера
        /// </summary>
        ...
        /// <summary>
        /// Появляеться если Клиент нагрубил но извинился перед диспетчером
        /// </summary>
        ...
        /// <summary>
        /// Метод в котором хранятьтся слова для извенения
        /// </summary>
        ...
        /// <summary>
        /// Метод в котором Клиент извеняется перед Диспетчером
        /// </summary>
